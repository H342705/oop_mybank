...
class Person {
  ...
  async setPersonalInformation(): Promise<void> {
  ...
  displayPersonalInformation(): void {
  ...
  async performTransaction(): Promise<void> {
    const answers = await inquirer.prompt([
      ...
      },
      {
        ...
        when: (answers:any) => answers.transactionType !== 'Check Balance',
      },
    ]);
...
async function runBankAccountSystem(): Promise<void> {
